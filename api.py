...
class FtxClient:
    ...
    def get_hist_funding_rates(self, start_time, end_time, future_name) -> List[dict]:
        return self._get(f'funding_rates?start_time={start_time}&end_time={end_time}&future={future_name}')

    def get_hist_spot_margin(self, start_time, end_time) -> List[dict]:
        return self._get(f'spot_margin/history?start_time={start_time}&end_time={end_time}')

    def get_historical_index(self,market_name: str,resolution: int ,start_time: float ,end_time: float ) -> dict:
        return self._get(f'indexes/{market_name}/candles', dict(resolution=resolution,start_time=start_time,end_time=end_time))
